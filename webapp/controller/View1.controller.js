sap.ui.define([
	...
	return Controller.extend("zcontrato.zcontrato.controller.View1", {
	onInit: function () {
this._wizard = this.byId("CreateProductWizard");
		...
		additionalInfoValidation: function () {
			var name = this.byId("cliente").getValue();
			

		

			if (name.length < 6) {
				this.model.setProperty("/clienteState", "Error");
			} else {
				this.model.setProperty("/clienteState", "None");
			}
		...
		onPress: function () {
				this._wizard.nextStep();
				var rejectBtn = this.getView().byId("btn1");
